...
export default function Cart() {
  ...
  return (
    <div id="Cart">
      <Link to={"/products"}>
        <div className="CartGoBack">
          <a href="">
            <i class="icon-ic_back"></i>Go to previous page
          </a>
        </div>
      </Link>
      ...
      <div id="MyCart">
        ...
        {items.map((e) => (
          <div className="CartProductsList">
            <div className="CartProductsListImg">
              <img src={e.image} alt="" />
            </div>
            ...
            <div className="CartProductsListPrice">
              ...
              <div>
                {" "}
                <span className="MrpCut">₹{e.price}</span>{" "}
                <span className="MrpCutGreen">({e.discount}% off)</span>{" "}
              </div>
